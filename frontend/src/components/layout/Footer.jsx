...
export default function Footer() {
  return (
    <footer className="border-t border-imperial-border mt-auto">
      <div className="max-w-6xl mx-auto px-4 py-10">
        {/* Top row — brand + socials */}
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6 mb-8">
          <div>
            <p className="font-serif text-xl text-imperial-gold tracking-wide mb-1">Librarium</p>
            <p className="text-xs text-imperial-muted tracking-widest uppercase">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="flex-1 h-px bg-imperial-border" />
          <span className="text-imperial-gold/30 text-xs tracking-widest">✦</span>
          <div className="flex-1 h-px bg-imperial-border" />
        </div>

        {/* Bottom row — disclaimer */}
        <p className="text-center text-xs text-imperial-muted/50 leading-relaxed">
